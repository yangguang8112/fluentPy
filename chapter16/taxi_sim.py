...
def main(end_time = DEFAULT_END_TIME, num_taxis = DEFAULT_NUMBER_OF_TAXIS, seed=DEFAULT_SEED):
    random.seed(seed)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--seed', type=int, default=DEFAULT_SEED, help='random generator seed (for testing)')
